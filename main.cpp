...
void main()
{
	...
	std::cout << "Mais les potions sont sauvgadees entierement, par contre tout les autres objets (l'epee, l'arc et la carte) ne sauvgarde que la dernière creer" << std::endl;
	system("PAUSE");
